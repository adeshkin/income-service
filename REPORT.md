...
Таблица - locust_results/run_final.csv
Вывод:
С ростом числа пользователей: 
   1.1 медианное время ответа почти не изменяется
   1.2 макс время ответа растет значительно: 10 пользователей - 30, 50 - 59, 100 - 110
   1.3 RPS растет: 10 пользователей - 5, 50 - 25, 100 - 50
Таким образом, сервис не достиг предела на 100 пользователях, но 95% интервал слишком сильно оторвался от медианы, что значит, для небольшой части пользователей сервис будет отвечать медленнее. 
